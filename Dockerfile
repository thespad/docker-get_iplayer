...
RUN apk add --update --no-cache ffmpeg perl-cgi perl-mojolicious perl-lwp-protocol-https perl-xml-libxml perl-libwww jq curl icu-libs krb5-libs libgcc libintl libssl1.1 libstdc++ zlib && \
